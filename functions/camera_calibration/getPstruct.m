...
nrCam        = length(utvid.Tracking.usecams);
try
...
for i=1:4
    ...
    if nrCam == 2
        Ptemp = [   mov{utvid.Tracking.usecams(1)}.P(1,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(2)}.P(1,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(1)}.P(2,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(2)}.P(2,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(1)}.P(3,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(2)}.P(3,i)*eye(nrMarkers)];
        Ptemp_or = [mov{utvid.Tracking.usecams(1)}.P(1,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(2)}.P(1,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(1)}.P(2,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(2)}.P(2,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(1)}.P(3,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(2)}.P(3,i)*eye(nrMarkers_or)];
    %in the case of 3 cameras
    elseif nrCam == 3
        Ptemp = [   mov{utvid.Tracking.usecams(1)}.P(1,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(2)}.P(1,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(3)}.P(1,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(1)}.P(2,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(2)}.P(2,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(3)}.P(2,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(1)}.P(3,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(2)}.P(3,i)*eye(nrMarkers); ...
                    mov{utvid.Tracking.usecams(3)}.P(3,i)*eye(nrMarkers)];
        Ptemp_or = [mov{utvid.Tracking.usecams(1)}.P(1,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(2)}.P(1,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(3)}.P(1,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(1)}.P(2,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(2)}.P(2,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(3)}.P(2,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(1)}.P(3,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(2)}.P(3,i)*eye(nrMarkers_or); ...
                    mov{utvid.Tracking.usecams(3)}.P(3,i)*eye(nrMarkers_or)];
    end
...
for i=1:nrCam
    Pstruct.P{i} = mov{utvid.Tracking.usecams(i)}.P;
end
Pstruct_or = Pstruct;
Pstruct.Pext    = Pext;
