...
if utvid.settings.nrOrMar ~= 0
    i = 1;
    [utvid.Xinit_or, ~] = twoDto3D_3cam([utvid.coords.or.left.x(:,i);utvid.coords.or.right.x(:,i);...
...
if utvid.settings.nrOrMar ~= 0
    utvid.Tracking.Xest_or     = []; utvid.Tracking.Xest_or.Rext(:,:,1) = utvid.Xinit_or; % R_init
