...
%     axes(handles.hax{1,1}), imshow(utvid.Tracking.FrameLorig,[]);
%     axes(handles.hax{1,2}), imshow(utvid.Tracking.FrameRorig,[]);
%     axes(handles.hax{1,3}), imshow(utvid.Tracking.FrameMorig,[]);
% 	
